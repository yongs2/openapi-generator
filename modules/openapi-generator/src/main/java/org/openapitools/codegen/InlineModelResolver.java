    ...
    private void flattenComposedChildren(String key, List<Schema> children, boolean skipAllOfInlineSchemas) {
        ...
        while (listIterator.hasNext()) {
            ...
            if ((component != null) &&
                ...
                LOGGER.info(">> FIXME << flattenComposedChildren.03,key[{}],skipAllOfInlineSchemas[{}],innerModelName[{}],innerModel[{}],existing[{}]", key, skipAllOfInlineSchemas, innerModelName, innerModel, existing);
