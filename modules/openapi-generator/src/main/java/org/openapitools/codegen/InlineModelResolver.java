...
public class InlineModelResolver {
    ...
    private void flattenRequestBody(OpenAPI openAPI, String pathname, Operation operation) {
        ...
        content.forEach((contentType, mediaType) -> {
            ...
            if (this.isNeedInlineSchema(requestBodySchema)) {
                ...
                this.flattenSchema(openAPI, requestBodySchema, requestBodySchemaName);
    ...
    private void flattenParameters(OpenAPI openAPI, String pathname, Operation operation) {
        ...
        for (final Parameter parameter : parameters) {
            ...
            flattenSchema(openAPI, parameterModel, parameterModelName);
        }
    }
        ...
        for (String statusCode : responses.keySet()) {
            ...
            response.getContent().forEach((contentType, MediaType) -> {
                ...
                if (this.isNeedInlineSchema(responseModel)) {
                    ...
                    this.flattenSchema(openAPI, responseModel, responseModelName);
    ...
    private void flattenSchema(OpenAPI openAPI, Schema schema, String path) {
        if (ModelUtils.isModel(schema)) {
            ...
            for (String key : properties.keySet()) {
                ...
                if (ModelUtils.isModel(property)) {
                    ...
                    this.flattenSchema(openAPI, property, inlineModelName);
            ...
            if (ModelUtils.isModel(items)) {
                ...
                this.flattenSchema(openAPI, items, inlineModelName2);
        ...
        if (ModelUtils.isMapSchema(schema)) {
            Schema additionalProperties = ModelUtils.getAdditionalProperties(openAPI, schema);
            this.flattenSchema(openAPI, additionalProperties, path + "_additional");
        }
    }
    ...
    private void flattenComponents(OpenAPI openAPI) {
        ...
        for (String modelName : modelNames) {
            ...
            this.flattenSchema(openAPI, schema, modelName);
        }
    }
